...
def convert_format_me(res, class_id_list):
    """将检测结果格式转换为me-api的格式。注意res为多张图片的检测结果，格式如下：
    [[[30, 234, 145, 370, 0.7212, 3]],[],[[10, 67, 89, 188, 0.8315, 2], [300, 230, 388, 315, 0.5634, 4]]]
    """
...
def filter_scores(result, score=0.05):
    """过滤分数太小的框，防止计算量过大。

    Args：
        result: y_pred。
        score：过滤分数，即分数小于score的框都丢掉。
    Return:
        过滤后的y_pred。
    """
